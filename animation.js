...
const channel =
ably.channels.get("ably-elecciones-completo");
...
const mask1 =
banner.querySelector(".mask1");

const mask2 =
banner.querySelector(".mask2");

const logoBox =
banner.querySelector(".logoBox");
...
const candidateImg =
banner.querySelector(".candidateImg");

const logo =
banner.querySelector(".logo");
...
const mosca =
document.getElementById("mosca");

const texto =
document.getElementById("texto");

const logoMosca =
document.getElementById("logoMosca");

const logoEE =
document.getElementById("logoEE");
...
const mask =
logoEE.querySelector(".circle-mask");
...
const candidateImg =
candidatosBanner.querySelector(
".candidateImg"
);
